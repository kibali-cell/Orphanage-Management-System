        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <form action="<?php $_PHP_SELF ?>" method="post" class="ui form">
                    ...
                    <h4 class="ui dividing header">Demand Draft</h4>
                    <div class="field">
                    ...
                    <h4 class="ui dividing header">Donor Information</h4>
                    <div class="field">
                        <label>Name:</label>
