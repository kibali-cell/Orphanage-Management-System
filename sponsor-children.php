            ...
            <div class="twelve wide column">
                ...
                <?php
                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        if ($conn->query($sql) === TRUE && $conn->query($sql2) === TRUE) {
                                $unsponsored_page = './admin/children.php';
                ...
                <form action="<?php $_PHP_SELF ?>" method="post" class="ui form">
                    ...
                    <div class="two fields">
                        ...
                        <div class="field">
                            * 1 year, pay 900,000/=  or $340 USD <br>
                            * 2 year, pay 1,600,000/=   or $680 USD <br>
                            * 3 year, pay 3,000,000/=  or $1270 USD <br>
                            * 5 year, pay 5,000,000/= or $2120 USD <br>
                        </div>
                    </div>
                    ...
                    <h4 class="ui dividing header">Sponsor's Personal Information</h4>
                    <div class="fields">
