        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <div class="ui pointing menu">
                    <a class="item" href="children.php">
                        Sponsored Children
                    </a>
                ...
                <div class="ui segment">
                    <div class="ui divided items">
                        ...
                        <div class="item">
                        <a href="child-details.php?cid=<?php echo $row['cid']; ?>" class="child-link">
                            <div class="ui image">
                            ...
                            <div class="extra">
                                <a class="ui right button" href="../donation.php">Donated</a>
                                <a class="ui right button" href="../sponsor-children.php?cid=<?php echo $row['cid']; ?>">Sponsored</a>
                                <a class="ui right button" href="../send-gift.php?cid=<?php echo $row['cid']; ?>">Add gift</a>
                            </div>
                            </div>
                            </a>
                        </div>
