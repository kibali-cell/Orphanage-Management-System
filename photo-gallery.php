    ...
    <div class="ui container">
        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <h2 class="ui block header">Quality Education</h2>
                ...
                <h2 class="ui block header">Ufundi Community Development</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Health Care</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Agriculture and Commercial Projects</h2>
                <div class="ui medium images">
